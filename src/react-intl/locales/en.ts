...
export default {
  ...
  menubar_inbox: 'Inbox',
  menubar_consents: 'Consents',
  menubar_my_data: 'My data',
  ...
  popup_success_fetch_data_text: 'Your Registration certificate from Arbetsförmedlingen has now been fetched. Click view data to review all the fetched data.',
